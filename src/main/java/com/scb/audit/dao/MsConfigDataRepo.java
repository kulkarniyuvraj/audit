...
public interface MsConfigDataRepo extends JpaRepository<MsConfig, Integer> {
	...
	*/
	@Query("select t.param_value from MsConfig t where t.country= ?1 AND t.trx_desc= ?2 AND t.param_1 = ?3")
	String getDuplicateParamValue(String country, String trx_desc, String param_1 );
